...
@Table
@NamedQueries({ 
		@NamedQuery(name = "UserComments.findCommentsForCatelog", query = "SELECT u FROM UserComments u where u.catelog.id = :pCatelogId")
})
public class UserComments {
	...
	public String toString() {
		return "UserComments [id=" + id + ", user=" + user + ", catelog=" + catelog + ", comments=" + comments + "]";
	}
	/**
	 * @return the comments
	 */
